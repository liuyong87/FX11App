...
public class HanziToPinyin {
    ...
    static {
        specialHanzi.put("4e58", '\u5382');//乘->厂
        specialHanzi.put("53e5", '\u72d7');//句->狗
        specialHanzi.put("961a", '\u770b');//阚->看
        specialHanzi.put("53f6", '\u4e5f');//叶->也
        specialHanzi.put("5352", '\u732a');//卒->猪
        specialHanzi.put("8d3e", '\u7532');//贾->甲
        specialHanzi.put("6c88", '\u5ba1');//沈->审
        specialHanzi.put("4fde", '\u4e8e');//俞->于
        specialHanzi.put("5408", '\u548c');//合->和
        specialHanzi.put("85cf", '\u810f');//藏->脏
        specialHanzi.put("6641", '\u8d85');//晁->超
        specialHanzi.put("6d17", '\u663e');//洗->显
        specialHanzi.put("796d", '\u6458');//祭->摘
        specialHanzi.put("5398", '\u897f');//厘->西
        specialHanzi.put("7cfb", '\u897f');//系->西
        specialHanzi.put("4f1a", '\u5feb');//会->快
        specialHanzi.put("76db", '\u751f');//盛->生
        specialHanzi.put("4e0d", '\u5426');//不->否
        specialHanzi.put("6d63", '\u5b8c');//浣->完
        specialHanzi.put("4e7e", '\u94b1');//乾->钱
        specialHanzi.put("533a", '\u6b27');//区->欧
        specialHanzi.put("4ec7", '\u7403');//仇->球
        specialHanzi.put("772d", '\u968f');//睢->随
        specialHanzi.put("79d8", '\u5fc5');//秘->必
        specialHanzi.put("89e3", '\u5199');//解->写
        specialHanzi.put("6298", '\u86c7');//折->蛇
        specialHanzi.put("6734", '\u86c7');//朴->票
        specialHanzi.put("67e5", '\u70b8');//查->炸
        specialHanzi.put("76d6", '\u4e2a');//盖->个
        specialHanzi.put("5c09", '\u7389');//尉->玉
        specialHanzi.put("4e50", '\u6708');//乐->月
        specialHanzi.put("7e41", '\u5761');//繁->坡
        specialHanzi.put("80fd", '\u5976');//能->奶
        specialHanzi.put("4e5c", '\u634f');//乜->捏
        specialHanzi.put("80e5", '\u8bb8');//胥->许
        specialHanzi.put("5355", '\u5c71');//单->山
        specialHanzi.put("6fb9", '\u4f46');//澹->但
        specialHanzi.put("6bb3", '\u4e66');//殳->书
        specialHanzi.put("53c2", '\u6df1');//参->深
        specialHanzi.put("66fe", '\u6b63');//曾->正
