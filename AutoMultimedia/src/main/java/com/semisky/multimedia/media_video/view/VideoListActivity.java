...
public class VideoListActivity extends FragmentActivity implements View.OnClickListener {
    private static final String TAG = Logutil.makeTagLog(VideoListActivity.class);
    ...
    private int mCurrentFragmentIndex = Definition.MediaListConst.FRAGMENT_LIST_USB1_BY_VIDEO;

    // Fragment tag
    private static final String FRAGMENT_USB1_LIST_TAG = VideoListFragment.class.getSimpleName() + "ByUsb1";
    private static final String FRAGMENT_USB2_LIST_TAG = VideoListFragment.class.getSimpleName() + "ByUsb2";
    // Fragment index
    private static final int FRAGMENT_USB1_LIST_INDEX = Definition.MediaListConst.FRAGMENT_LIST_USB1_BY_VIDEO;
    private static final int FRAGMENT_USB2_LIST_INDEX = Definition.MediaListConst.FRAGMENT_LIST_USB2_BY_VIDEO;
    ...
    private void initShowFragment(int fragmentFlag) {
        ...
        if (null == mFragments[FRAGMENT_USB1_LIST_INDEX]) {
            VideoListFragment videoListFragmentByUsb1 = new VideoListFragment();
            videoListFragmentByUsb1.setUsbFlag(Definition.FLAG_USB1);
            mFragments[FRAGMENT_USB1_LIST_INDEX] = videoListFragmentByUsb1;

        }

        if (null == mFragments[FRAGMENT_USB2_LIST_INDEX]) {
            VideoListFragment videoListFragmentByUsb2 = new VideoListFragment();
            videoListFragmentByUsb2.setUsbFlag(Definition.FLAG_USB2);
            mFragments[FRAGMENT_USB2_LIST_INDEX] = videoListFragmentByUsb2;
        }
