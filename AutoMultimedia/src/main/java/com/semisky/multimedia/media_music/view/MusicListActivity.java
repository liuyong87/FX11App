...
import com.semisky.multimedia.media_music.presenter.MusicListContainerPresenter;

/**
 * Created by LiuYong on 2018/8/9.
 */

public class MusicListActivity extends BaseActivity<IMusicListContainerView,MusicListContainerPresenter<IMusicListContainerView>> implements IMusicListContainerView, OnClickListener {
    private static final String TAG = Logutil.makeTagLog(MusicListActivity.class);
    ...
    @Override
    protected MusicListContainerPresenter<IMusicListContainerView> createPresenter() {
        return new MusicListContainerPresenter();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.rl_usb_one:
                mPresenter.handlerSidebarEventByUsb1();
                break;
            case R.id.rl_usb_two:
                mPresenter.handlerSidebarEventByUsb2();
                break;
            case R.id.rl_bt:
                mPresenter.handlerSidebarEventByBt();
                break;
